...
from dash import Dash, html, dcc, Input, Output  # pip install dash (version 2.0.0 or higher)
...
df = pd.read_csv("abbabynames2020.csv", encoding="latin1")

# ------------------------------------------------------------------------------
# App layout
app.layout = html.Div([
    html.H1("Alberta Baby Names Bot", style={'text-align': 'center'}),
    html.H3("Explore baby-name trends over the past 40 years:", style={'text-align': 'left'}),
    html.Br(),
    ...
    html.H4("Total babies (1980 to 2020):"),
    ...
    dcc.Markdown("**• Created by [Robson Fletcher](https://twitter.com/cbcfletch)**"),
...
def update_graph(option_slctd):
    ...
    return container, container_boy_total, container_girl_total, fig, container2, container2_boyrank_high, container2_boyrank_low, container2_girlrank_high, container2_girlrank_low, fig2
